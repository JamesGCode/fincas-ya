...
export function PropertiesTable({
  ...
  return (
    <div className="bg-white/50 backdrop-blur-sm">
      {/* Table Header */}
      <div className="hidden md:grid grid-cols-[80px_2fr_1.2fr_100px_160px_120px] gap-4 px-8 py-5 bg-gray-100/75 border-b border-gray-100 text-[10px] font-black text-gray-400 uppercase tracking-widest">
        <span>Imagen</span>
      ...
      <div className="divide-y divide-gray-50/50">
        {properties.map((property) => (
          <div
            ...
            className="flex flex-col md:grid md:grid-cols-[80px_2fr_1.2fr_100px_160px_120px] gap-4 md:gap-4 items-start md:items-center px-6 md:px-8 py-6 hover:bg-orange-50/30 transition-all group relative border-l-4 border-l-transparent hover:border-l-orange-500 cursor-pointer"
          >
