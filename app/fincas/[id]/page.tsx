...
export default async function FincaDetailPage({ params }: Props) {
  ...
  const isFavorite = finca.rating >= 4.8;
        ...
        <div className="container mx-auto px-0 md:px-6 lg:px-6">
          <div className="grid lg:grid-cols-3 max-lg:gap-10">
            ...
            <div className="lg:col-span-2 lg:mr-10">
              ...
              <div className="space-y-6 mb-12 max-md:px-3">
                <div className="bg-blue-600/10 border border-blue-500/20 rounded-2xl p-6 flex items-center gap-4">
                  ...
                  <p className="text-blue-100 text-sm leading-relaxed font-medium">
                    ...
                    <span className="text-blue-400 font-bold underline cursor-pointer">
                      Whatsapp
                    </span>
                    .
                  </p>
              ...
              <div className="border border-border/50 rounded-2xl md:p-8 px-4.5 py-8 mb-0 bg-card/80 max-md:mx-3">
                ...
                <div className="space-y-4 text-muted-foreground text-sm leading-relaxed px-2">
                  <p>
                    <strong className="text-foreground">FINCASYA</strong> no se
                    compromete a realizar devoluciones de dinero en caso de
                    cancelaciones fortuitas por razones ajenas a nuestra
                    voluntad, se aplazará la fecha en caso dado siempre y cuando
                    la novedad sea notificada como mínimo siete (7) días hábiles
                    antes de la fecha de ingreso registrada.
                  </p>
                  <p>
                  ...
                  <p>
                    <strong className="text-foreground">FINCASYA</strong> no se
                    hará responsable de accidentes ocasionados durante su
                  ...
                  <p>
                    ...
                    clandestinos no autorizados ni contratados, agresiones a las
                    autoridades o a terceros;{" "}
                  ...
                  <p className="font-bold text-primary pt-2">
                    Todos los valores anteriormente mencionados NO incluyen IVA.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-1 max-md:px-3 md:ml-4">
              <div className="sticky top-28 bg-card/50 backdrop-blur-sm border border-border/50 rounded-2xl p-6">
                <div className="mb-6">
          ...
          {/* Recommendations */}
          <Recommendations fincas={fincas} currentId={finca.id} />
        </div>
      </section>
